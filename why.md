来源：https://basicapp.docs.xihanfun.com/why
...
它的后端建立在 [XiHan.Framework](https://framework.docs.xihanfun.com/) 之上，而框架是 **66 个可独立引用的 NuGet 包**，本身就是公开发布的产品。
...
- [为什么选择曦寒框架](https://framework.docs.xihanfun.com/why)：如果你要的是底座而不是成品
