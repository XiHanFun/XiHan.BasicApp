...
public sealed class PrintTemplateResolverTests
{
    ...
    public async Task ResolveAsync_CacheKeyShouldContainTenantScopeAndCode()
    {
        ...
        Assert.Equal(
            PrintingCacheKeys.PrintTemplate(27, (int)PrintTemplateScope.Global, "SHIP"),
    ...
    /// </summary>
    private static async Task<PrintTemplateCacheItem?> InvokeCacheFactoryAsync(
        Func<Task<PrintTemplateCacheItem>> factory)
    {
