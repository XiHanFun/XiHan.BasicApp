...
/// 系统部门服务实现
/// </summary>
public class SysDepartmentService : CrudApplicationServiceBase<SysDepartment, DepartmentDto, long, CreateDepartmentDto, UpdateDepartmentDto>, ISysDepartmentService
{
    ...
    /// 更新部门
    /// </summary>
    public override async Task<DepartmentDto> UpdateAsync(long id, UpdateDepartmentDto input)
    {
        var department = await _departmentRepository.GetByIdAsync(id) ??
