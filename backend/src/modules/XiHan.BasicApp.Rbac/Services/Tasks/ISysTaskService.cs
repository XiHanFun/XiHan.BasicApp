...
// CreateTime:2025/12/28 16:05:00
// ----------------------------------------------------------------
...
public interface ISysTaskService : ICrudApplicationService<TaskDto, XiHanBasicAppIdType, CreateTaskDto, UpdateTaskDto>
{
    ...
    /// <returns></returns>
    Task<TaskDto?> GetByTaskCodeAsync(string taskCode);
    ...
    /// <returns></returns>
    Task<List<TaskDto>> GetByStatusAsync(TaskStatus taskStatus);
    ...
    /// <returns></returns>
    Task<List<TaskDto>> GetPendingTasksAsync(int count = 100);
    ...
    /// <returns></returns>
    Task<List<TaskDto>> GetByTaskGroupAsync(string taskGroup);
