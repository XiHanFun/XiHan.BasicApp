...
/// 系统用户安全服务接口
/// </summary>
public interface ISysUserSecurityService : ICrudApplicationService<UserSecurityDto, XiHanBasicAppIdType, CreateUserSecurityDto, UpdateUserSecurityDto>
{
    /// <summary>
    /// 根据用户ID获取用户安全信息
    /// </summary>
    ...
    /// <returns></returns>
    Task<UserSecurityDto?> GetByUserIdAsync(XiHanBasicAppIdType userId);
