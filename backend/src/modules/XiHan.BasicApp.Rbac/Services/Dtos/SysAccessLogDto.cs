...
// FileName:SysAccessLogDto
// Guid:d528152c-d6e9-4396-addb-b479254bad93
// Author:zhaifanhua
...
/// 系统访问日志查询 DTO
/// </summary>
public class SysAccessLogGetDto : RbacFullAuditedDtoBase
{
    /// <summary>
    /// 租户ID
    /// </summary>
    ...
    /// 访问结果
    /// </summary>
    public AccessResult AccessResult { get; set; } = AccessResult.Success;
