...
public class SysResourceSeeder : DataSeederBase
{
    ...
    protected override async Task SeedInternalAsync()
    {
        ...
        var resources = new List<SysResource>
        {
            ...
            new() { ParentId = null, ResourceCode = "permission", ResourceName = "权限管理", ResourceType = ResourceType.Menu, ResourcePath = "/system/permission", Icon = "shield", Description = "权限管理功能", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 102 },
            new() { ParentId = null, ResourceCode = "department", ResourceName = "机构管理", ResourceType = ResourceType.Menu, ResourcePath = "/system/org", Icon = "building-2", Description = "机构管理功能", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 103 },
            new() { ParentId = null, ResourceCode = "notice", ResourceName = "通知公告", ResourceType = ResourceType.Menu, ResourcePath = "/system/notice", Icon = "bell", Description = "通知公告功能", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 104 },
            ...
            new() { ParentId = null, ResourceCode = "user_session", ResourceName = "会话管理", ResourceType = ResourceType.Menu, ResourcePath = "/system/session", Icon = "shield-check", Description = "在线会话管理", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 106 },
            new() { ParentId = null, ResourceCode = "review", ResourceName = "审核管理", ResourceType = ResourceType.Menu, ResourcePath = "/system/review", Icon = "clipboard-check", Description = "审核管理功能", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 107 },
            ...
            new() { ParentId = null, ResourceCode = "config", ResourceName = "参数配置", ResourceType = ResourceType.Menu, ResourcePath = "/platform/config", Icon = "sliders-horizontal", Description = "系统参数配置", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 202 },
            new() { ParentId = null, ResourceCode = "dict", ResourceName = "字典管理", ResourceType = ResourceType.Menu, ResourcePath = "/platform/dict", Icon = "book-open", Description = "数据字典管理", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 203 },
            new() { ParentId = null, ResourceCode = "task", ResourceName = "任务调度", ResourceType = ResourceType.Menu, ResourcePath = "/platform/job", Icon = "clock", Description = "任务调度管理", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 204 },
            new() { ParentId = null, ResourceCode = "monitor", ResourceName = "系统监控", ResourceType = ResourceType.Menu, ResourcePath = "/platform/server", Icon = "activity", Description = "系统监控功能", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 205 },
            ...
            new() { ParentId = null, ResourceCode = "region", ResourceName = "行政区域", ResourceType = ResourceType.Menu, ResourcePath = "/platform/region", Icon = "globe", Description = "行政区域管理", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 207 },
            ...
            new() { ParentId = null, ResourceCode = "plugin", ResourceName = "动态插件", ResourceType = ResourceType.Menu, ResourcePath = "/platform/plugin", Icon = "puzzle", Description = "动态插件管理", IsRequireAuth = true, IsPublic = false, Status = YesOrNo.Yes, Sort = 209 },
