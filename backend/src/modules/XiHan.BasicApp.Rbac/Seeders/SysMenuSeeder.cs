...
public class SysMenuSeeder : DataSeederBase
{
    ...
    protected override async Task SeedInternalAsync()
    {
        ...
        var menus = new List<SysMenu>
        {
            ...
            new() { ResourceId = GetResourceId(resourceMap, "notice"), ParentId = null, MenuName = "通知公告", MenuCode = "notice", MenuType = MenuType.Menu, Path = "/system/notice", Component = "System/Notification/Index", RouteName = "SystemNotice", Icon = "bell", Title = "通知公告", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 104 },
            ...
            new() { ResourceId = GetResourceId(resourceMap, "monitor"), ParentId = null, MenuName = "系统监控", MenuCode = "monitor", MenuType = MenuType.Menu, Path = "/platform/server", Component = "System/Monitor/Index", RouteName = "SystemMonitor", Icon = "activity", Title = "系统监控", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 207 },
            new() { ResourceId = GetResourceId(resourceMap, "cache"), ParentId = null, MenuName = "缓存管理", MenuCode = "cache", MenuType = MenuType.Menu, Path = "/platform/cache", Component = "System/Cache/Index", RouteName = "SystemCache", Icon = "database", Title = "缓存管理", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 208 },
            new() { ResourceId = GetResourceId(resourceMap, "file"), ParentId = null, MenuName = "文件管理", MenuCode = "file", MenuType = MenuType.Menu, Path = "/platform/file", Component = "System/File/Index", RouteName = "SystemFile", Icon = "folder-open", Title = "文件管理", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 209 },
