...
public class SysMenuSeeder : DataSeederBase
{
    ...
    protected override async Task SeedInternalAsync()
    {
        ...
        var menus = new List<SysMenu>
        {
            ...
            new() { ResourceId = GetResourceId(resourceMap, "permission"), ParentId = null, MenuName = "权限管理", MenuCode = "permission", MenuType = MenuType.Menu, Path = "/system/permission", Component = "System/Permission/Index", RouteName = "SystemPermission", Icon = "shield", Title = "权限管理", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 104 },
            new() { ResourceId = GetResourceId(resourceMap, "notice"), ParentId = null, MenuName = "通知公告", MenuCode = "notice", MenuType = MenuType.Menu, Path = "/system/notice", Component = "System/Notification/Index", RouteName = "SystemNotice", Icon = "bell", Title = "通知公告", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 105 },
            ...
            new() { ResourceId = GetResourceId(resourceMap, "config"), ParentId = null, MenuName = "参数配置", MenuCode = "config", MenuType = MenuType.Menu, Path = "/platform/config", Component = "System/Config/Index", RouteName = "SystemConfig", Icon = "sliders-horizontal", Title = "参数配置", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 203 },
            new() { ResourceId = GetResourceId(resourceMap, "dict"), ParentId = null, MenuName = "字典管理", MenuCode = "dict", MenuType = MenuType.Menu, Path = "/platform/dict", Component = "System/Dict/Index", RouteName = "SystemDict", Icon = "book-open", Title = "字典管理", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 204 },
            new() { ResourceId = GetResourceId(resourceMap, "task"), ParentId = null, MenuName = "任务调度", MenuCode = "task", MenuType = MenuType.Menu, Path = "/platform/job", Component = "System/Task/Index", RouteName = "SystemTask", Icon = "clock", Title = "任务调度", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 205 },
            new() { ResourceId = GetResourceId(resourceMap, "monitor"), ParentId = null, MenuName = "系统监控", MenuCode = "monitor", MenuType = MenuType.Menu, Path = "/platform/server", Component = "System/Monitor/Index", RouteName = "SystemMonitor", Icon = "activity", Title = "系统监控", IsExternal = false, IsCache = true, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 206 },
            ...
            // 消息中心
            new() { ResourceId = GetResourceId(resourceMap, "messaging"), ParentId = null, MenuName = "消息中心", MenuCode = "messaging", MenuType = MenuType.Directory, Path = "/messaging", Component = null, RouteName = null, Redirect = "/messaging/message", Icon = "message-square", Title = "消息中心", IsExternal = false, IsCache = false, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 250 },
            ...
            // 日志管理
            new() { ResourceId = GetResourceId(resourceMap, "log"), ParentId = null, MenuName = "日志管理", MenuCode = "log", MenuType = MenuType.Directory, Path = "/log", Component = null, RouteName = null, Redirect = "/log/vislog", Icon = "file-text", Title = "日志管理", IsExternal = false, IsCache = false, IsVisible = true, IsAffix = false, Status = YesOrNo.Yes, Sort = 300 },
        ...
        await UpdateMenuParentIdAsync("system", ["user", "role", "department", "permission", "notice", "oauth_app", "user_session", "review"]);
        await UpdateMenuParentIdAsync("platform", ["tenant", "menu", "config", "dict", "task", "monitor", "cache", "file"]);
