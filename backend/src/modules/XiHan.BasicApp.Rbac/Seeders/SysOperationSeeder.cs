...
public class SysOperationSeeder : DataSeederBase
{
    ...
    protected override async Task SeedInternalAsync()
    {
        ...
        var operations = new List<SysOperation>
        {
            ...
            new() { OperationCode = "download", OperationName = "下载", OperationTypeCode = OperationTypeCode.Download, Category = OperationCategory.System, HttpMethod = HttpMethodType.GET, Description = "下载文件", Icon = "cloud-download", Color = "primary", IsRequireAudit = false, Status = YesOrNo.Yes, Sort = 22 },
