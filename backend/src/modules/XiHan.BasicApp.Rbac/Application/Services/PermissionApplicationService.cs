...
using Mapster;
using XiHan.BasicApp.Rbac.Application.Dtos.Permissions;
...
/// 权限应用服务
/// </summary>
public class PermissionApplicationService : CrudApplicationServiceBase<SysPermission, SysPermissionDto, long, CreateSysPermissionDto, UpdateSysPermissionDto>
{
