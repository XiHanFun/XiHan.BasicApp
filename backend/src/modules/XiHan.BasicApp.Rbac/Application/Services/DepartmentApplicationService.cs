...
using Mapster;
using XiHan.BasicApp.Rbac.Application.Dtos.Departments;
...
/// 部门应用服务
/// </summary>
public class DepartmentApplicationService : CrudApplicationServiceBase<SysDepartment, SysDepartmentDto, long, CreateSysDepartmentDto, UpdateSysDepartmentDto>
{
