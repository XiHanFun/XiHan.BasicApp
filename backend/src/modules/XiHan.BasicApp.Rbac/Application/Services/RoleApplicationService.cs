...
using Mapster;
using XiHan.BasicApp.Rbac.Application.Dtos.Roles;
...
/// 角色应用服务
/// </summary>
public class RoleApplicationService : CrudApplicationServiceBase<SysRole, SysRoleDto, long, CreateSysRoleDto, UpdateSysRoleDto>
{
