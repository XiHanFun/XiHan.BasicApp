...
using Mapster;
using XiHan.BasicApp.Rbac.Application.Dtos.Tenants;
...
/// 租户应用服务
/// </summary>
public class TenantApplicationService : CrudApplicationServiceBase<SysTenant, SysTenantDto, long, CreateSysTenantDto, UpdateSysTenantDto>
{
