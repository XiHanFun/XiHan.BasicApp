...
using Mapster;
using XiHan.BasicApp.Rbac.Application.Dtos.Menus;
...
/// 菜单应用服务
/// </summary>
public class MenuApplicationService : CrudApplicationServiceBase<SysMenu, SysMenuDto, long, CreateSysMenuDto, UpdateSysMenuDto>
{
