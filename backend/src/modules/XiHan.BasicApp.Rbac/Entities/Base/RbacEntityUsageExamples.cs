...
namespace Examples
{
    ...
    /// 适用于需要自定义编码规则的场景
    /// </summary>
    [SugarTable("example_string_id", "字符串 ID 实体示例表")]
    public class StringIdExample : RbacEntityBase<string>
    {
        /// <summary>
        /// 分类编码
        /// </summary>
        [SugarColumn(ColumnDescription = "分类编码", Length = 20, IsNullable = false)]
