...
public partial class SysFile
{
    ...
    //{
    //    return Storages?.FirstOrDefault(s => s.IsPrimary && s.Status == Enums.StorageStatus.Normal);
    //}
    ...
    //{
    //    return Storages?.Where(s => s.Status == Enums.StorageStatus.Normal).OrderBy(s => s.SortOrder).ToList() ?? [];
    //}
    ...
    //{
    //    return Status == Enums.FileStatus.Normal && !IsExpired;
    //}
    ...
    //{
    //    Status = Enums.FileStatus.Deleted;
    //}
    ...
    //{
    //    Status = Enums.FileStatus.Archived;
    //}
    ...
    //public bool IsImage()
    //{
    //    return FileType == Enums.FileType.Image;
    //}
    ...
    //public bool IsVideo()
    //{
    //    return FileType == Enums.FileType.Video;
    //}
    ...
    //{
    //    return FileType == Enums.FileType.Document;
    //}
