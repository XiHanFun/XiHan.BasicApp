...
[SugarIndex("IX_SysDict_TenantId", nameof(TenantId), OrderByType.Asc)]
[SugarIndex("IX_SysDict_TenantId_Status", nameof(TenantId), OrderByType.Asc, nameof(Status), OrderByType.Asc)]
