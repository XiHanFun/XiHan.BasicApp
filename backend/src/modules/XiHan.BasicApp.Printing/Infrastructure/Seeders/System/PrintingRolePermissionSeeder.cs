...
public class PrintingRolePermissionSeeder : DataSeederBase
{
    ...
    /// 构造函数
    /// </summary>
    public PrintingRolePermissionSeeder(
        ISqlSugarClientResolver clientResolver,
        ILogger<PrintingRolePermissionSeeder> logger,
    ...
    /// 种子数据优先级
    /// </summary>
    public override int Order => 502;

    /// <summary>
    /// 种子数据名称
    /// </summary>
    public override string Name => "[Printing]系统角色权限种子数据";
    ...
    protected override async Task SeedInternalAsync()
    {
        ...
        using (var platformScope = _currentTenant.Change(null))
        {
            ...
            {
                Logger.LogWarning("打印权限不存在，跳过打印角色权限种子");
                return;
            }
