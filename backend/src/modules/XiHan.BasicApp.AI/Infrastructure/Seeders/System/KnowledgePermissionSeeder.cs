...
/// 知识库权限种子数据
/// </summary>
public class KnowledgePermissionSeeder : PlatformDataSeederBase
{
    /// <summary>
    /// 构造函数
    /// </summary>
    ...
    {
        var client = DbClient;
        var resources = await client.Queryable<SysResource>().Where(r => r.ResourceCode == KnowledgePermissionCodes.Resource).ToListAsync();
