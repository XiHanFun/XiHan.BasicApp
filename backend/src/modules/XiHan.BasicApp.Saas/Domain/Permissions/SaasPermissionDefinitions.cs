...
public static class SaasPermissionDefinitions
{
    ...
    [
        ...
        new(
            ...
            "用户双因素重置",
            "重置当前租户用户双因素认证（OTP），清除绑定后用户可重新设置",
            "[\"saas\",\"user-security\"]",
            true,
            2450,
            2450),
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.User.Export,
            "用户导出",
            "导出当前数据范围内的用户列表数据",
            "[\"saas\",\"user\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.OperationLog.Export,
            "操作日志导出",
            "导出操作日志数据",
            "[\"saas\",\"operation-log\",\"export\"]",
            false,
            2470,
            2470),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.AccessLog.Export,
            "访问日志导出",
            "导出访问日志数据",
            "[\"saas\",\"access-log\",\"export\"]",
            false,
            2480,
            2480),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.ApiLog.Export,
            "API日志导出",
            "导出开放接口日志数据",
            "[\"saas\",\"api-log\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.LoginLog.Export,
            "登录日志导出",
            "导出登录日志数据",
            "[\"saas\",\"login-log\",\"export\"]",
            false,
            2500,
            2500),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.ExceptionLog.Export,
            "异常日志导出",
            "导出异常日志数据",
            "[\"saas\",\"exception-log\",\"export\"]",
            false,
            2510,
            2510),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.DiffLog.Export,
            "数据变更日志导出",
            "导出数据变更（差异）日志数据",
            "[\"saas\",\"diff-log\",\"export\"]",
            false,
            2520,
            2520),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Config.Import,
            "系统配置导入",
            "批量导入系统配置数据",
            "[\"saas\",\"config\",\"import\"]",
            true,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Role.Export,
            "角色导出",
            "导出当前数据范围内的角色列表数据",
            "[\"saas\",\"role\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Department.Export,
            "部门导出",
            "导出当前数据范围内的部门列表数据",
            "[\"saas\",\"department\",\"export\"]",
            false,
            2550,
            2550),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Permission.Export,
            "权限定义导出",
            "导出当前数据范围内的权限定义列表数据",
            "[\"saas\",\"permission\",\"export\"]",
            false,
            2560,
            2560),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.FieldLevelSecurity.Export,
            "字段级安全导出",
            "导出当前数据范围内的字段级安全策略列表数据",
            "[\"saas\",\"field-level-security\",\"export\"]",
            false,
            2570,
            2570),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.PermissionRequest.Export,
            "权限申请导出",
            "导出当前数据范围内的权限申请列表数据",
            "[\"saas\",\"permission-request\",\"export\"]",
            false,
            2580,
            2580),
        new(
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.MessageTemplate.Export,
            "消息模板导出",
            "导出当前数据范围内的消息模板列表数据",
            "[\"saas\",\"message-template\",\"export\"]",
            false,
            2600,
            2600),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Review.Export,
            "系统审查导出",
            "导出当前数据范围内的系统审查列表数据",
            "[\"saas\",\"review\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.File.Export,
            "系统文件导出",
            "导出当前数据范围内的系统文件列表数据",
            "[\"saas\",\"file\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.OAuthApp.Export,
            "OAuth应用导出",
            "导出当前数据范围内的 OAuth 应用列表数据",
            "[\"saas\",\"oauth-app\",\"export\"]",
            false,
            2630,
            2630),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Menu.Export,
            "菜单导出",
            "导出当前数据范围内的菜单列表数据",
            "[\"saas\",\"menu\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Dict.Export,
            "系统字典导出",
            "导出当前数据范围内的系统字典列表数据",
            "[\"saas\",\"dict\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Config.Export,
            "系统配置导出",
            "导出当前数据范围内的系统配置列表数据",
            "[\"saas\",\"config\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Version.Export,
            "版本导出",
            "导出当前数据范围内的系统版本列表数据",
            "[\"saas\",\"version\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.UserSession.Export,
            "会话导出",
            "导出当前数据范围内的用户会话列表数据",
            "[\"saas\",\"user-session\",\"export\"]",
            false,
            2690,
            2690),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Message.Export,
            "消息导出",
            "导出当前数据范围内的邮件短信列表数据",
            "[\"saas\",\"message\",\"export\"]",
            false,
        ...
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.Notification.Export,
            "通知导出",
            "导出当前数据范围内的系统通知列表数据",
            "[\"saas\",\"notification\",\"export\"]",
            false,
            2710,
            2710),
        new(
            ...
            "版本套餐导出",
            "导出当前数据范围内的租户版本套餐列表数据",
            "[\"saas\",\"tenant-edition\",\"export\"]",
            false,
            2720,
            2720),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.StorageConfig.Export,
            "存储配置导出",
            "导出当前数据范围内的存储配置列表数据",
            "[\"saas\",\"storage-config\",\"export\"]",
            false,
            2730,
            2730),
        new(
            SaasPermissionCodes.Module,
            SaasPermissionCodes.ConstraintRule.Export,
            "约束规则导出",
            "导出当前数据范围内的约束规则列表数据",
            "[\"saas\",\"constraint-rule\",\"export\"]",
            false,
            2740,
            2740)
    ];
