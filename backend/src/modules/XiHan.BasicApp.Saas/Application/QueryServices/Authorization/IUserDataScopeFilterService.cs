...
/// </summary>
/// <param name="Unrestricted">是否不限制（平台 / 全部数据范围 / 无登录上下文）</param>
...
/// <summary>
/// 用户数据范围过滤服务：依据成员关系上的数据范围覆盖（自定义时取 UserDataScope）或角色数据范围（RoleDataScope），
/// 结合部门归属，经 <c>DataScopeDecisionDomainService</c> 裁决出可见的用户主键集合，供列表查询施加数据范围过滤。
/// </summary>
