...
public static class OAuthTokenApplicationMapper
{
        ...
        DateTimeOffset now)
    {
        ...
        return new OAuthTokenListItemDto
        {
            ...
            IsAccessTokenExpired = token.AccessTokenExpirationTime <= now,
            RefreshTokenExpirationTime = token.RefreshTokenExpirationTime,
            IsRefreshTokenExpired = token.RefreshTokenExpirationTime.HasValue && token.RefreshTokenExpirationTime.Value <= now,
        ...
        DateTimeOffset now)
    {
        ...
        return new OAuthTokenDetailDto
        {
            ...
            Scopes = item.Scopes,
            Status = item.Status,
            AccessTokenExpirationTime = item.AccessTokenExpirationTime,
            IsAccessTokenExpired = item.IsAccessTokenExpired,
            RefreshTokenExpirationTime = item.RefreshTokenExpirationTime,
