...
public static class ApiLogApplicationMapper
{
    ...
    public static ApiLogListItemDto ToListItemDto(SysOpenApiLog apiLog)
    {
        ...
        return new ApiLogListItemDto
        {
            ...
            ControllerName = apiLog.ControllerName,
            ActionName = apiLog.ActionName,
            IsSignatureValid = apiLog.IsSignatureValid,
            SignatureType = apiLog.SignatureType,
            StatusCode = apiLog.StatusCode,
            RequestIp = apiLog.RequestIp,
            RequestLocation = apiLog.RequestLocation,
            UserAgent = apiLog.UserAgent,
            Browser = apiLog.Browser,
            Referer = apiLog.Referer,
            ...
            RequestParams = apiLog.RequestParams,
            RequestBody = apiLog.RequestBody,
            ResponseBody = apiLog.ResponseBody,
            RequestHeaders = apiLog.RequestHeaders,
            ResponseHeaders = apiLog.ResponseHeaders,
            ExceptionStackTrace = apiLog.ExceptionStackTrace,
            ExtendData = apiLog.ExtendData,
