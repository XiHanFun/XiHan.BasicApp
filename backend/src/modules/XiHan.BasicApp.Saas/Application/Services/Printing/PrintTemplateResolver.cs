...
public sealed class PrintTemplateResolver : IPrintTemplateResolver
{
    ...
    private readonly IDistributedCache<SaasPrintTemplateCacheItem, string> _cache;
    ...
    public PrintTemplateResolver(
        ...
        IDistributedCache<SaasPrintTemplateCacheItem, string> cache)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var cacheKey = SaasCacheKeys.PrintTemplate(requestTenantId, (int)scope, normalizedCode);
    ...
    /// </summary>
    private async Task<SaasPrintTemplateCacheItem> ResolveCacheItemAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (template is null)
        {
            return new SaasPrintTemplateCacheItem
            {
                Found = false,
