...
public sealed class PrintTemplateAppService : SaasApplicationService, IPrintTemplateAppService
{
    ...
    /// <inheritdoc />
    [UnitOfWork(true)]
    [PermissionAuthorize(SaasPermissionCodes.PrintTemplate.Create)]
    ...
    /// <inheritdoc />
    [UnitOfWork(true)]
    [PermissionAuthorize(SaasPermissionCodes.PrintTemplate.Update)]
    ...
    /// <inheritdoc />
    [UnitOfWork(true)]
    [PermissionAuthorize(SaasPermissionCodes.PrintTemplate.Status)]
    ...
    /// <inheritdoc />
    [UnitOfWork(true)]
    [PermissionAuthorize(SaasPermissionCodes.PrintTemplate.Delete)]
    ...
    private async Task EnsureWritableScopeAsync(PrintTemplateScope scope, CancellationToken cancellationToken)
    {
        ...
        if (!await _permissionChecker.IsGrantedAsync(
                userId.ToString(), SaasPermissionCodes.PrintTemplate.GlobalManage, cancellationToken))
        {
