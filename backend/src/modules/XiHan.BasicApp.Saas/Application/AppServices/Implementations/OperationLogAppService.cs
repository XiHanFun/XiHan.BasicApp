...
public class OperationLogAppService : ApplicationServiceBase, IOperationLogAppService
{
    ...
    /// 构造函数
    /// </summary>
    public OperationLogAppService(ISqlSugarDbContext dbContext, ISqlSugarSplitTableExecutor splitTableExecutor)
    {
    ...
    public async Task<PageResultDtoBase<OperationLogDto>> PageAsync(BasicAppPRDto input)
    {
        ...
        var list = await _splitTableExecutor.CreateQueryable<SysOperationLog>(DbClient)
