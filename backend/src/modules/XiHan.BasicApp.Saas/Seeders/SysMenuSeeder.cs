...
public class SysMenuSeeder : DataSeederBase
{
    ...
    private static List<SysMenu> BuildTemplates(IReadOnlyDictionary<string, SysPermission> permissionMap)
    {
        ...
        [
            ...
            CreateMenu("field_level_security", "字段级安全", "platform", "/platform/field-level-security", "System/FieldLevelSecurity/Index", "SystemFieldLevelSecurity", "scan-eye", 350, LookupPermissionId(permissionMap, "field_level_security:read")),
            CreateMenu("config", "运行配置", "platform", "/platform/config", "System/Config/Index", "SystemConfig", "sliders-horizontal", 360, LookupPermissionId(permissionMap, "config:read")),
            CreateMenu("dict", "字典中心", "platform", "/platform/dict", "System/Dict/Index", "SystemDict", "book-marked", 370, LookupPermissionId(permissionMap, "dict:read")),
            CreateMenu("task", "任务调度", "platform", "/platform/task", "System/Task/Index", "SystemTask", "clock-3", 380, LookupPermissionId(permissionMap, "task:read")),
            CreateMenu("file", "文件中心", "platform", "/platform/file", "System/File/Index", "SystemFile", "folder-open", 390, LookupPermissionId(permissionMap, "file:read")),
            CreateMenu("cache", "缓存管理", "platform", "/platform/cache", "System/Cache/Index", "SystemCache", "database-zap", 400, LookupPermissionId(permissionMap, "cache:read")),
            CreateMenu("monitor", "系统监控", "platform", "/platform/monitor", "System/Monitor/Index", "SystemMonitor", "activity", 410, LookupPermissionId(permissionMap, "monitor:read")),
