  ...
  <div class="flex overflow-hidden flex-col gap-2 p-3 h-full">
    ...
    >
      <div class="space-y-3 text-sm">
        ...
        <div>
          <span class="font-medium text-gray-500">实体：</span>
          {{ detailData.entityType }} - {{ detailData.entityName }} (ID: {{ detailData.entityId }})
        </div>
        <div>
          <span class="font-medium text-gray-500">表名/主键：</span>
          {{ detailData.tableName }} / {{ detailData.primaryKey }} =
          {{ detailData.primaryKeyValue }}
        </div>
        <div>
        ...
        <div>
          <span class="font-medium text-gray-500">变更描述：</span>
          {{ detailData.changeDescription }}
        </div>
        <div>
