...
const fields: ListFieldSchema[] = [
  ...
  { key: 'exceptionType', title: '异常类型', dataType: 'string', advancedSearch: true, minWidth: 160, order: 15 },
  { key: 'exceptionMessage', title: '异常消息', dataType: 'string', minWidth: 260, order: 16 },
  { key: 'exceptionSource', title: '异常源', dataType: 'string', advancedSearch: true, minWidth: 140, order: 17 },
  { key: 'exceptionLocation', title: '异常发生位置', dataType: 'string', advancedSearch: true, minWidth: 200, order: 18 },
  {
    key: 'severityLevel',
    title: '严重级别',
    dataType: 'enum',
  ...
  { key: 'requestPath', title: '请求路径', dataType: 'string', advancedSearch: true, minWidth: 200, order: 20 },
  { key: 'requestMethod', title: '请求方法', dataType: 'string', advancedSearch: true, width: 90, order: 21 },
  ...
  { key: 'operationIp', title: '操作 IP', dataType: 'string', searchable: true, searchPlaceholder: '搜索操作 IP', minWidth: 130, order: 25 },
  { key: 'operationLocation', title: '操作位置', dataType: 'string', minWidth: 160, order: 26 },
  { key: 'browser', title: '浏览器', dataType: 'string', minWidth: 120, order: 27 },
  { key: 'os', title: '操作系统', dataType: 'string', minWidth: 120, order: 28 },
  {
    key: 'deviceType',
    title: '设备类型',
    dataType: 'enum',
  ...
  { key: 'applicationName', title: '应用程序名称', dataType: 'string', advancedSearch: true, minWidth: 130, order: 30 },
  { key: 'applicationVersion', title: '应用程序版本', dataType: 'string', minWidth: 120, order: 31 },
  { key: 'environmentName', title: '环境名称', dataType: 'string', advancedSearch: true, minWidth: 100, order: 32 },
  { key: 'serverHostName', title: '服务器主机', dataType: 'string', minWidth: 140, order: 33 },
  { key: 'threadId', title: '线程 ID', dataType: 'number', width: 90, order: 34 },
  { key: 'processId', title: '进程 ID', dataType: 'number', width: 90, order: 35 },
  { key: 'exceptionTime', title: '异常时间', dataType: 'datetime', sortable: true, minWidth: 170, order: 36 },
  {
    key: 'isHandled',
    title: '处理状态',
    dataType: 'boolean',
  ...
  { key: 'handledTime', title: '处理时间', dataType: 'datetime', minWidth: 170, order: 38 },
  { key: 'errorCode', title: '错误代码', dataType: 'string', advancedSearch: true, minWidth: 100, order: 39 },
  { key: 'createdTime', title: '创建时间', dataType: 'datetime', minWidth: 170, order: 40 },
  // 仅高级搜索（不作为列，范围条件置于高级区末尾）
  { key: 'exceptionTimeStart', title: '开始时间', dataType: 'datetime', visible: false, advancedSearch: true, searchPlaceholder: '开始时间', order: 50 },
  { key: 'exceptionTimeEnd', title: '结束时间', dataType: 'datetime', visible: false, advancedSearch: true, searchPlaceholder: '结束时间', order: 51 },
]
