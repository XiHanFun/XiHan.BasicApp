  ...
  { key: 'fileName', title: t('chat.audit.file_name'), dataType: 'string', minWidth: 140, order: 16, render: row => (row as unknown as ChatAuditListItemDto).fileName || '-' },
  {
    ...
    render: (row) => {
      ...
      return item.isRecalled
        ? h(XhTagRoot, { variant: 'outline', tone: 'danger' }, () => h(XhTagLabel, () => t('chat.audit.recalled_yes')))
        : h(XhTagRoot, { variant: 'outline', tone: 'neutral' }, () => h(XhTagLabel, () => t('chat.audit.recalled_no')))
    },
  },
