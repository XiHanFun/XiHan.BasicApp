...
const schema = computed<PageSchema>(() => ({
  ...
  actions: [
    ...(canMaintain.value
      ? [{ key: 'create', title: t('setting.print_template.action_create'), scope: 'page' as const, type: 'primary' as const, icon: 'lucide:plus', permission: 'setting.print-template.create' }]
      : []),
