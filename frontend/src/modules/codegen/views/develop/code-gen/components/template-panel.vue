...
import { XhBadge, XhButton, XhFieldControl, XhFieldErrorText, XhFieldLabel, XhFieldRoot, XhFormFieldGroup, XhFormRoot } from '@xihan-ui/vue'
...
const fields = computed<ListFieldSchema[]>(() => [
  ...
  { key: 'fileExtension', title: t('develop.code_gen.template.col_file_extension'), dataType: 'string', width: 90, sortable: true, order: 6 },
  {
    ...
    render: (row) => {
      ...
      return h(XhBadge, { variant: 'subtle', size: 'sm', tone: r.isBuiltIn ? 'warning' : 'neutral' }, () => (r.isBuiltIn ? t('develop.code_gen.template.built_in') : t('develop.code_gen.template.custom')))
    },
  },
  {
    key: 'isEnabled',
