export default {
  ...
  auth: {
    ...
    password_rule_lower: 'Password must contain a lowercase letter',
    password_rule_upper: 'Password must contain an uppercase letter',
    password_rule_digit: 'Password must contain a digit',
    password_rule_special: 'Password must contain a special character',
    send_code: 'Send Code',
